...
// vm.runInThisContext内で実行されるため、importやrequireは使用不可
module.exports = {
  mpee_onWillParseMarkdown: onWillParseMarkdown,
  mpee_onDidParseMarkdown: onDidParseMarkdown
};

async function onWillParseMarkdown(markdown) {

  // ここから

  // 動作オプションの選択
  selectedOptionType = 'type3';
  ...
  class NumberingManager extends MarkdownParser {
    constructor(markdown, userOptions = null) {
      ...
      this.options = {
        ...
        excludeIndentClasses: ['page-center', 'page-end'] // indentStringを適用しないクラス名
...
async function onDidParseMarkdown(html) {
